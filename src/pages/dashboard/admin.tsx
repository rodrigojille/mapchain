    ...
    <>
      ...
      <div style={{ background: '#f8f9fa', minHeight: '100vh', paddingTop: 64, fontFamily: 'Inter, Arial, sans-serif' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', padding: 16 }}>
          ...
          <h2 style={{ fontWeight: 800, fontSize: '2rem', color: '#222', marginBottom: 12 }}>Admin Dashboard</h2>
          <div style={{ color: '#5f6368', marginBottom: 24 }}>Manage users, platform stats, and contracts. (To be implemented)</div>
        </div>
      </div>
    </>
  );
